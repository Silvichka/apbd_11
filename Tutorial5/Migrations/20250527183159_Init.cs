    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "alice.bennett@clinic.com", "Alice", "Bennett" },
                    { 2, "liam.walker@health.org", "Liam", "Walker" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Anti-inflammatory drug", "Ibuprofen", "Tablet" },
                    { 2, "Antihistamine", "Cetirizine", "Syrup" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Oliver", "Stone" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Emma", "Brown" }
                });
